...
// import { Button } from "antd";  // Импортируем кнопку из Ant Design
// import { Toys } from "../components/Toys"; // Импортируем компонент Toys
// import { createToy, getAllToys, updateToy } from "../services/toys"; // Импортируем функцию для получения игрушек
// import { CreateToy, Mode } from "../components/CreateToy";
// import { Toy } from "../Models/Toy";
...
//       {/* Отображаем игрушки через компонент Toys */}
//       {loading ? <p>Загрузка...</p> : <Toys toys={toys} onToyClick={openUpdateModal} />}
//     </div>
//   );
// }